...
public class Level1 extends Level
{
	...
	void loadLevel()
	{
		 ...
		 * Screen Walls
		 */
        world.walls.add(new Wall(width / 2, 5, width, 10, view));
        world.walls.add(new Wall(width / 2, height - 5, width, 10, view));
        world.walls.add(new Wall(5, height / 2, 10, height, view));
        world.walls.add(new Wall(width - 5, height / 2, 10, height, view));
        
        world.walls.add(new Wall(300, 800, 300, 50, view));
        world.walls.add(new Wall(300, 950, 50, 300, view));

        world.walls.add(new Wall(width / 2 - 15, height / 2 - 100, 50, height - 200, view));
        
        world.endPoints.add(new EndPoint(width - 100, 100, 200, 200, view));
